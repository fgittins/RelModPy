...
class TestMuller(TestCase):
    ...
    def test_f(self):
        ...
        polymode.solve(self.l, (omegaguess1, omegaguess2, omegaguess3),
                       method='Muller')
        self.assertAlmostEqual(polymode.omega.real*self.M, Reomegatrue*self.M,
                               delta=1e-3)
        self.assertAlmostEqual(polymode.omega.imag*self.M, Imomegatrue*self.M,
                               delta=1e-7)
...
class TestSimplex(TestCase):
    ...
    def test_f(self):
        ...
        polymode.solve(self.l, omegaguess, method='Simplex')
        self.assertAlmostEqual(polymode.omega.real*self.M, Reomegatrue*self.M,
                               delta=1e-3)
        self.assertAlmostEqual(polymode.omega.imag*self.M, Imomegatrue*self.M,
                               delta=1e-7)
