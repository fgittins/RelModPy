"""Polytropic equations of state for barotropic matter.
...
class Barotrope(EOS):
    """Abstract base class for barotropic equations of state.
...
class EnergyPolytrope(Barotrope):
